...
u8 sBackgroundMusicDefaultVolume[] = {
    ...
    70,  // SEQ_EVENT_CUTSCENE_COLLECT_STAR
    70,  // SEQ_MENU_TITLE_SCREEN
    60,  // SEQ_LEVEL_GRASS
    60,  // SEQ_LEVEL_INSIDE_CASTLE
    65,  // SEQ_LEVEL_WATER
    65,  // SEQ_LEVEL_HOT
    65,  // SEQ_LEVEL_BOSS_KOOPA
    60,  // SEQ_LEVEL_SNOW
    65,  // SEQ_LEVEL_SLIDE
    80,  // SEQ_LEVEL_SPOOKY
    65,  // SEQ_EVENT_PIRANHA_PLANT
    80,  // SEQ_LEVEL_UNDERGROUND
    65,  // SEQ_MENU_STAR_SELECT
    65,  // SEQ_EVENT_POWERUP
    60,  // SEQ_EVENT_METAL_CAP
    65,  // SEQ_EVENT_KOOPA_MESSAGE
    60,  // SEQ_LEVEL_KOOPA_ROAD
    60,  // SEQ_EVENT_HIGH_SCORE
    65,  // SEQ_EVENT_MERRY_GO_ROUND
    60,  // SEQ_EVENT_RACE
    60,  // SEQ_EVENT_CUTSCENE_STAR_SPAWN
    65,  // SEQ_EVENT_BOSS
    65,  // SEQ_EVENT_CUTSCENE_COLLECT_KEY
    65,  // SEQ_EVENT_ENDLESS_STAIRS
    65,  // SEQ_LEVEL_BOSS_KOOPA_FINAL
    60,  // SEQ_EVENT_CUTSCENE_CREDITS
    60,  // SEQ_EVENT_SOLVE_PUZZLE
    60,  // SEQ_EVENT_TOAD_MESSAGE
    60,  // SEQ_EVENT_PEACH_MESSAGE
    65,  // SEQ_EVENT_CUTSCENE_INTRO
    60,  // SEQ_EVENT_CUTSCENE_VICTORY
    60,  // SEQ_EVENT_CUTSCENE_ENDING
    65,  // SEQ_MENU_FILE_SELECT
    0,   // SEQ_EVENT_CUTSCENE_LAKITU (not in JP)
    40,  // SEQ_ASTRO_MAN_FULL
    40,  // SEQ_SEINFELD_THEME
};
