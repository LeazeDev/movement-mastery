...
short rank_times[8][7][4] = {
    ...
    // level 1
    { { _9s(25), _11s(0), _15s(0), _20s(0) },   // 09"80
      { _9s(6), _10s(0), _15s(0), _20s(0) },    // 09"16
      { _8s(3), _9s(0), _15s(0), _20s(0) },     // 08"06
      { _14s(21), _16s(0), _20s(0), _30s(0) },  // 14"66
      { _13s(24), _15s(0), _20s(0), _30s(0) },  // 13"76
      { _20s(0), _22s(0), _30s(0), _40s(0) },   // 19"96
      { _40s(2), _40s(5), _50s(0), _60s(0) } }, // 41"96
    // level 2
    { { _6s(12), _7s(15), _10s(0), _15s(0) },   // 06"36
      { _8s(6), _9s(0), _12s(0), _20s(0) },     // 08"16
      { _6s(18), _8s(0), _12s(0), _20s(0) },    // 06"56
      { _11s(0), _12s(0), _15s(0), _20s(0) },   // 10"96
      { _8s(21), _10s(0), _15s(0), _20s(0) },   // 08"66
      { _24s(0), _26s(3), _30s(0), _40s(0) },   // 23"96
      { _30s(9), _40s(2), _50s(0), _60s(0) } }, // 38"96
    // level 3
    { { _9s(15), _11s(0), _15s(0), _20s(0) },   // 09"46
      { _13s(0), _15s(0), _20s(0), _30s(2) },   // 12"96
      { _8s(27), _10s(0), _15s(0), _20s(0) },   // 08"86
      { _11s(18), _13s(0), _15s(0), _20s(0) },  // 11"56
      { _10s(0), _11s(0), _15s(0), _20s(0) },   // 09"96
      { _24s(0), _26s(0), _30s(0), _40s(0) },   // 23"96
      { _40s(6), _50s(0), _60s(0), _70s(0) } }, // 45"96
    // level 4
    { { _5s(25), _6s(0), _8s(0), _12s(0) },     // 05"80
      { _8s(6), _10s(0), _15s(0), _20s(0) },    // 08"16
      { _10s(0), _11s(0), _15s(0), _20s(0) },   // 09"96
      { _9s(0), _10s(0), _15s(0), _20s(0) },    // 08"96
      { _8s(4), _9s(0), _15s(0), _20s(6) },     // 08"10
      { _17s(15), _19s(0), _23s(0), _30s(0) },  // 17"46
      { _30s(5), _30s(7), _40s(5), _60s(0) } }, // 34"96
    // level 5
    { { _8s(6), _10s(0), _15s(0), _20s(0) },    // 08"16
      { _10s(12), _12s(0), _17s(0), _25s(0) },  // 10"36
      { _6s(4), _7s(0), _10s(0), _15s(0) },     // 06"10
      { _6s(9), _8s(0), _13s(0), _20s(0) },     // 06"26
      { _5s(18), _7s(0), _10s(0), _15s(0) },    // 05"56
      { _19s(24), _21s(0), _25s(0), _30s(5) },  // 19"76
      { _30s(0), _30s(2), _40s(0), _50s(0) } }, // 29"96
};
