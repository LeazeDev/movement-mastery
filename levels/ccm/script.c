...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 4650, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 4650, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 4650, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 4650, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 5150, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 5150, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 5150, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 2600, 5150, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 250, 2600, 4900, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 250, 2600, 4900, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 250, 2600, 4900, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 250, 2600, 4900, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -250, 2600, 4900, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		...
		OBJECT(MODEL_BLUE_COIN, -250, 2600, 4900, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -250, 2600, 4900, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 3370, 5350, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 3370, 5350, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 3370, 5350, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 0, 3370, 5350, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN_SWITCH, 0, 2350, 4900, 0, 0, 0, 0x00000000, bhvBlueCoinSwitch),
		...
		OBJECT(MODEL_RED_COIN, 0, 1800, 3000, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 3400, 1700, 2300, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 3467, 3950, 67, 0, 90, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 3600, 2100, -3600, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 0, 1800, -2900, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -3400, 1700, -2500, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -3700, 2800, 0, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -3000, 2000, 3000, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_WOODEN_SIGNPOST, -3750, 1600, 3200, 0, 90, 0, (2 << 16), bhvMessagePanel),
		OBJECT(MODEL_NONE, -3400, 2500, 3400, 0, 135, 0, (10 << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_STAR, -6400, 3400, 0, 0, 0, 0, (0 << 24), bhvStar),
		OBJECT(MODEL_STAR, 0, 2700, -7520, 0, 0, 0, (1 << 24), bhvStar),
		OBJECT(MODEL_STAR, 4500, 2800, -4500, 0, 0, 0, (2 << 24), bhvStar),
		OBJECT(MODEL_STAR, 0, 3250, 2700, 0, 0, 0, (3 << 24), bhvStar),
		OBJECT(MODEL_STAR, 0, 5200, 0, 0, -45, 0, (4 << 24), bhvStar),
		OBJECT(MODEL_NONE, -3000, 2100, 3000, 0, 0, 0, (5 << 24), bhvHiddenRedCoinStar),
