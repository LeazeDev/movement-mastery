...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_NONE, 0, 1600, 1900, 0, -180, 0, (10 << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_BITS_WARP_PIPE, -300, 1100, 1100, 0, 0, 0, (1 << 16), bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE, 300, 1100, 1100, 0, 0, 0, (2 << 16), bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE, -600, 1150, 500, 0, 0, 0, (3 << 16), bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE, 600, 1150, 500, 0, 0, 0, (4 << 16), bhvWarpPipe),
		OBJECT(MODEL_BITS_WARP_PIPE, 0, 1250, -100, 0, 0, 0, (5 << 16), bhvWarpPipe),
		OBJECT(MODEL_WOODEN_SIGNPOST, 0, 1010, 1420, 0, 0, 0, (1 << 24), bhvMessagePanel),
